...
#define _0000_SAU_EDGE_FALL                     (0x0000U) /* falling edge is detected as the start bit.The input communication data is captured as is */
#define _0040_SAU_EDGE_RISING                   (0x0040U) /* rising edge is detected as the start bit.The input communication data is inverted and captured */
...
#define _0000_SAUm_CH3_START_TRG_OFF            (0x0000U) /* no trigger operation */
#define _0008_SAUm_CH3_START_TRG_ON             (0x0008U) /* sets the SEmn bit to 1 and enters the communication wait status */
/* Operation start trigger of channel 2 (SSm2) */
#define _0000_SAUm_CH2_START_TRG_OFF            (0x0000U) /* no trigger operation */
#define _0004_SAUm_CH2_START_TRG_ON             (0x0004U) /* sets the SEmn bit to 1 and enters the communication wait status */
/* Operation start trigger of channel 1 (SSm1) */
#define _0000_SAUm_CH1_START_TRG_OFF            (0x0000U) /* no trigger operation */
#define _0002_SAUm_CH1_START_TRG_ON             (0x0002U) /* sets the SEmn bit to 1 and enters the communication wait status */
/* Operation start trigger of channel 0 (SSm0) */
#define _0000_SAUm_CH0_START_TRG_OFF            (0x0000U) /* no trigger operation */
#define _0001_SAUm_CH0_START_TRG_ON             (0x0001U) /* sets the SEmn bit to 1 and enters the communication wait status */

/*
    Serial channel stop register m (STm) 
*/
/* Operation stop trigger of channel 3 (STm3) */
#define _0000_SAUm_CH3_STOP_TRG_OFF             (0x0000U) /* no trigger operation */
#define _0008_SAUm_CH3_STOP_TRG_ON              (0x0008U) /* clears the SEmn bit to 0 and stops the communication operation */
/* Operation stop trigger of channel 2 (STm2) */
#define _0000_SAUm_CH2_STOP_TRG_OFF             (0x0000U) /* no trigger operation */
#define _0004_SAUm_CH2_STOP_TRG_ON              (0x0004U) /* clears the SEmn bit to 0 and stops the communication operation */
/* Operation stop trigger of channel 1 (STm1) */
#define _0000_SAUm_CH1_STOP_TRG_OFF             (0x0000U) /* no trigger operation */
#define _0002_SAUm_CH1_STOP_TRG_ON              (0x0002U) /* clears the SEmn bit to 0 and stops the communication operation */
/* Operation stop trigger of channel 0 (STm0) */
#define _0000_SAUm_CH0_STOP_TRG_OFF             (0x0000U) /* no trigger operation */
#define _0001_SAUm_CH0_STOP_TRG_ON              (0x0001U) /* clears the SEmn bit to 0 and stops the communication operation */

/*
    Serial channel enable status register m (SEm) 
*/
/* Indication of operation enable/stop status of channel 3 (SEm3) */
#define _0000_SAUm_CH3_STATUS_DISABLE           (0x0000U) /* operation stops */
#define _0008_SAUm_CH3_STATUS_ENABLE            (0x0008U) /* operation is enabled */
/* Indication of operation enable/stop status of channel 2 (SEm2) */
#define _0000_SAUm_CH2_STATUS_DISABLE           (0x0000U) /* operation stops */
#define _0004_SAUm_CH2_STATUS_ENABLE            (0x0004U) /* operation is enabled */
/* Indication of operation enable/stop status of channel 1 (SEm1) */
#define _0000_SAUm_CH1_STATUS_DISABLE           (0x0000U) /* operation stops */
#define _0002_SAUm_CH1_STATUS_ENABLE            (0x0002U) /* operation is enabled */
/* Indication of operation enable/stop status of channel 0 (SEm0) */
#define _0000_SAUm_CH0_STATUS_DISABLE           (0x0000U) /* operation stops */
#define _0001_SAUm_CH0_STATUS_ENABLE            (0x0001U) /* operation is enabled */

/*
    Serial output enable register m (SOEm) 
*/
/* Serial output enable/stop of channel 2 (SOEm2) */
#define _0000_SAUm_CH2_OUTPUT_DISABLE           (0x0000U) /* stops output by serial communication operation */
#define _0004_SAUm_CH2_OUTPUT_ENABLE            (0x0004U) /* enables output by serial communication operation */
/* Serial output enable/stop of channel 0 (SOEm0) */
#define _0000_SAUm_CH0_OUTPUT_DISABLE           (0x0000U) /* stops output by serial communication operation */
#define _0001_SAUm_CH0_OUTPUT_ENABLE            (0x0001U) /* enables output by serial communication operation */

/*
    Serial output register m (SOm) 
*/
/* Serial clock output of channel 2 (CKOm2) */
#define _0000_SAUm_CH2_CLOCK_OUTPUT_0           (0x0000U) /* serial clock output value is 0 */
#define _0400_SAUm_CH2_CLOCK_OUTPUT_1           (0x0400U) /* serial clock output value is 1 */
/* Serial clock output of channel 0 (CKOm0) */
#define _0000_SAUm_CH0_CLOCK_OUTPUT_0           (0x0000U) /* serial clock output value is 0 */
#define _0100_SAUm_CH0_CLOCK_OUTPUT_1           (0x0100U) /* serial clock output value is 1 */
/* Serial data output of channel 2 (SOm2) */
#define _0000_SAUm_CH2_DATA_OUTPUT_0            (0x0000U) /* serial data output value is 0 */
#define _0004_SAUm_CH2_DATA_OUTPUT_1            (0x0004U) /* serial data output value is 1 */
/* Serial data output of channel 0 (SOm0) */
#define _0000_SAUm_CH0_DATA_OUTPUT_0            (0x0000U) /* serial data output value is 0 */
#define _0001_SAUm_CH0_DATA_OUTPUT_1            (0x0001U) /* serial data output value is 1 */

/*
    Serial output level register m (SOLm) 
*/
/* Selects inversion of the level of the transmit data of channel n in UART mode (SOLm2) */
#define _0000_SAUm_CHANNEL2_NORMAL              (0x0000U) /* communication data is output as is */
#define _0004_SAUm_CHANNEL2_INVERTED            (0x0004U) /* communication data is inverted and output */
/* Selects inversion of the level of the transmit data of channel n in UART mode (SOLm0) */
#define _0000_SAUm_CHANNEL0_NORMAL              (0x0000U) /* communication data is output as is */
#define _0001_SAUm_CHANNEL0_INVERTED            (0x0001U) /* communication data is inverted and output */

/*
    Serial standby control register m (SSCm) 
*/
/* Selection of whether to enable or disable the generation of communication error interrupts in the SNOOZE mode (SSECm) */
#define _0000_SAUm_INTSRE0_ENABLE               (0x0000U) /* enable the generation of error interrupts (INTSRE0/INTSRE2) */
#define _0002_SAUm_INTSRE0_DISABLE              (0x0002U) /* disable the generation of error interrupts (INTSRE0/INTSRE2) */
/* Setting of the SNOOZE mode (SWCm) */
#define _0000_SAUm_CH0_SNOOZE_OFF               (0x0000U) /* do not use the SNOOZE mode function */
#define _0001_SAUm_CH0_SNOOZE_ON                (0x0001U) /* use the SNOOZE mode function */
...
Typedef definitions
***********************************************************************************************************************/
extern uint8_t MODULE_FEEDBACK[100];
extern int FEEDBACK_LENGTHG;
extern uint8_t UART0_RECIEVED_DATA[100];
/***********************************************************************************************************************
Global functions
***********************************************************************************************************************/
