...
#define _10_RTC_CALENDER_COUNTER_10SEC                     (0x10U) /* 10-Second Count  */

#define _00_RTC_CALENDER_COUNTER_1SEC                      (0x00U) /* 1-Second Count  */
#define _30_RTC_CALENDER_COUNTER_10MIN                     (0x30U) /* minute count */

#define _01_RTC_CALENDER_COUNTER_1MIN                      (0x01U) /* minute count */
#define _10_RTC_CALENDER_COUNTER_10HOUR                    (0x10U) /* 10-Hour Count */

#define _04_RTC_CALENDER_COUNTER_1HOUR                     (0x04U) /* 1-Hour Count */
#define _00_RTC_CALENDER_COUNTER_10DAY                     (0x00U) /* 10-Day Count */

#define _05_RTC_CALENDER_COUNTER_1DAY                      (0x05U) /* 1-Day Count */
#define _02_RTC_CALENDER_COUNTER_1MONTH                    (0x02U) /* 1-Month Count */
#define _0020_RTC_CALENDER_COUNTER_10YEAR                  (0x0020U) /* 10-Year Count */

#define _0004_RTC_CALENDER_COUNTER_1YEAR                   (0x0004U) /* 1-Year Count */
