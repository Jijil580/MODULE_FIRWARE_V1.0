...
/* Timer output of channel 0 (TOMm0) */
#define _0000_TAU_CH0_MASTER_OUTPUT           (0x0000U) /* master channel output mode */
#define _0001_TAU_CH0_SLAVE_OUTPUT            (0x0001U) /* slave channel output mode” */
...
/*
    Timer I/O select register 0 (TIS0) 
*/
/* Selection of timer input used with channel 7 (TIS07,TIS06) */
#define _00_TAU_CH7_INPUT_TI07                (0x00U) /* input signal of timer input pin (TI07) */
#define _40_TAU_CH7_OUTPUT_RTCOUT             (0x40U) /* RTCOUT output signal */
#define _80_TAU_CH7_OUTPUT_RxD0               (0x80U) /* RXD0 input pin */
#define _C0_TAU_CH7_OUTPUT_ELC                (0xC0U) /* event input signal from ELC */
/* Selection of timer input used with channel 6 (TIS05) */
#define _00_TAU_CH6_INPUT_TI06                (0x00U) /* input signal of timer input pin (TI06) */
#define _20_TAU_CH6_INPUT_RTCOUT              (0x20U) /* RTCOUT output signal */
/* Selection of timer input used with channel 1 (TIS04) */
#define _00_TAU_CH1_INPUT_TI01                (0x00U) /* input signal of timer input pin (TI01) */
#define _10_TAU_CH1_INPUT_ELC                 (0x10U) /* event input signal from ELC */
/* Selection of timer input used with channel 0 (TIS03) */
#define _00_TAU_CH0_INPUT_TI00                (0x00U) /* input signal of timer input pin (TI00) */
#define _08_TAU_CH0_INPUT_ELC                 (0x08U) /* event input signal from ELC */
/* Selection of timer input used with channel 5 (TIS02,TIS01,TIS00) */
#define _00_TAU_CH5_INPUT_TI05                (0x00U) /* input signal of timer input pin (TI05) */
#define _01_TAU_CH5_INPUT_ELC                 (0x01U) /* event input signal from ELC */
#define _02_TAU_CH5_INPUT_TI05                (0x02U) /* input signal of timer input pin (TI05) */
#define _03_TAU_CH5_INPUT_fIM                 (0x03U) /* medium-speed on-chip oscillator clock (fIM) */
#define _04_TAU_CH5_INPUT_fIL                 (0x04U) /* low-speed on-chip oscillator clock (fIL) */
#define _05_TAU_CH5_INPUT_fSX                 (0x05U) /* subsystem clock (fSX) */

/*
    Noise Filter Enable Register 1  (NFEN1) 
*/
/* Enable/disable using noise filter of TI07 pin or RxD0 pin input signal (TNFEN07) */
...
void delay_In_Seconds(long int seconds);
